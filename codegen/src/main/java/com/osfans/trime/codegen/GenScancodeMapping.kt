...
/**
 * Adapted from fcitx5-android project
 * @see <a href="https://github.com/fcitx5-android/fcitx5-android/blob/8ed5609b137127dffa559040ca7dd6ca26da8317/codegen/src/main/java/org/fcitx/fcitx5/android/codegen/GenScancodeMapping.kt">GenScancodeMappingProcessor</a>
 */
internal class GenScancodeMappingProcessor(
    ...
    companion object {
        ...
        private val CHAR_MAP: List<Pair<String, String>> =
            listOf(
                "`" to "KEY_GRAVE",
                "1" to "KEY_1",
                "2" to "KEY_2",
    ...
    override fun finish() {
        ...
        val file =
            FileSpec
                .builder("com.osfans.trime.core", "ScancodeMapping")
...
class GenScancodeMappingProvider : SymbolProcessorProvider {
    override fun create(environment: SymbolProcessorEnvironment): SymbolProcessor = GenScancodeMappingProcessor(environment)
}
